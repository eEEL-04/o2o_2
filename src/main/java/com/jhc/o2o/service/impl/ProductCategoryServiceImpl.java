...
import com.jhc.o2o.dao.ProductCategoryDao;
...
public class ProductCategoryServiceImpl implements ProductCategoryService {
    ...
    public ProductCategoryExecution deleteProductCategory(long productCategoryId, long shopId) throws ProductCategoryOperationException {
        ...
        try {
            int effectiveNum = productDao.updateProductCategoryToNull(productCategoryId);
            if (effectiveNum<0){
                throw new ProductCategoryOperationException("商品类别更新为null失败");
            }
        }catch (Exception e){
        ...
        //删除productCategoryId
        try {
            int effectiveNum = productCategoryDao.deleteProductCategory(productCategoryId,shopId);
            if (effectiveNum<=0){
